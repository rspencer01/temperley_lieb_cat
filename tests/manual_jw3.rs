...
fn manual_jw3() {
    ...
    let jw3 = TLMorphism::new(vec![
        ...
        (TLDiagram::new(3,3, 0b0100, 0b0100), -R::from(quantum(2)) / Fraction::from(quantum(3))),
        (TLDiagram::new(3,3, 0b1000, 0b1000), -R::from(quantum(2)) / Fraction::from(quantum(3))),
        (TLDiagram::new(3,3, 0b0100, 0b1000), R::from(quantum(1)) / Fraction::from(quantum(3))),
        (TLDiagram::new(3,3, 0b1000, 0b0100), R::from(quantum(1)) / Fraction::from(quantum(3))),
